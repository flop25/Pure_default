<?php
$pattern['Pure_default_prefilter_index']['S']['table_content_begin']='#<div id="content" class="content">#';
$pattern['Pure_default_prefilter_index']['R']['table_content_begin']='<div id="content" class="content">
...
';
$pattern['Pure_default_prefilter_picture']['S']['table_content_begin']='#<div id="content" class="pictureContent">#';
$pattern['Pure_default_prefilter_picture']['R']['table_content_begin']='<div id="content" class="pictureContent">
  <table id="table_content" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td id="section_up_left">&nbsp;</td>
      <td id="section_up">&nbsp;</td>
...
/**************************** notification.tpl *****************************************************************/
$pattern['Pure_default_prefilter_notification']['S']['autre_content_begin']='#<p>\{\'#';  
$pattern['Pure_default_prefilter_notification']['R']['autre_content_begin']= '<div id="autre_content">
<p>{\'';
